...
class CovidIndia():
    ...
    def hangout(self, active, cured, deaths, total):
        ...
        url = 'https://chat.googleapis.com/v1/spaces/AAAAimyyXHo/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=u-1wNxlL_j45X0AK9iLHlBMok4ZLF779YpGv59mLXc8%3D'
